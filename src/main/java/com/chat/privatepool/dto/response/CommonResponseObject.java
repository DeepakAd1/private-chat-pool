...
public class CommonResponseObject {
    ...
    public static CommonResponseObject setErrorMessage(String message) {
    ...
    public static CommonResponseObject setData(String message, Object object) {
        return setData(null, message, object);
    }
}
